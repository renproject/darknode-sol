...
module.exports = {
  ...
  /** getMNetworkSize */
  GetAllMiners: async () => {
    const [minerList, deregisteredCount, toDeregisterCount, stayingRegisteredCount, toRegisterCount] = await minerRegistrar.getAllMiners.call();
  ...
  /** GetPublicKey */
  GetMinerPublicKey: async (account) => {
