const DarkNodeRegistrar = artifacts.require("TraderRegistrar");
const RepublicToken = artifacts.require("RepublicToken");
const chai = require("chai");
chai.use(require("chai-as-promised"));
chai.should();

contract("TraderRegistrar", function(accounts) {

  let tr, ren;

  before(async function () {
    ren = await RepublicToken.new();
    tr = await TraderRegistrar.new(ren.address, 100);
  });

  it("can register a Dark Node, call an epoch and check registration", async () => {
    await ren.approve(dnr.address, 100, {from: accounts[0]})
    await dnr.register("0x261c74f7dd1ed6a069e18375ab2bee9afcb10956", "0x42a990655bffe188c9823a2f914641a32dcbb1b242a990655bffe188c9823a2f914641a32dcbb1b242a990655bffe188c9823a2f914641a32dcbb1b2aabbccabbc", 100).should.not.be.rejectedWith();
  })

  it("can get the trader details of the Dark Node", async () => {
