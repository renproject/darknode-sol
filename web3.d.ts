// Taken from 0xProject
// https://github.com/0xProject/0x.js/tree/development/packages/web3-typescript-typings

// Repository license: https://github.com/0xProject/0x.js/blob/development/LICENSE
/*
