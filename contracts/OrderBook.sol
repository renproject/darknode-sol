...
contract OrderBook {
  ...
  //   traderRegistrar = MinerRegistrar(_traderRegistrar);
  // }
  ...
  //   uint256 orderFragmentCount = minerRegistrar.getPoolCount();
  ...
  //     minersToOrderFragmentIDs: minersToOrderFragmentIDs,
  //     matchFragments: []
  //   });
