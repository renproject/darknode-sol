...
export interface DarknodeRegistryContract {
    ...
    register(_darknodeID: string, _publicKey: string, _bond: number|string|BN, options?: Tx): Promise<TransactionObject<void>>;
    deregister(_darknodeID: string, options?: Tx): Promise<TransactionObject<void>>;
    epoch(options?: Tx): Promise<TransactionObject<void>>;
    transferStoreOwnership(_newOwner: string, options?: Tx): Promise<TransactionObject<void>>;
    updateMinimumBond(_nextMinimumBond: number|string|BN, options?: Tx): Promise<TransactionObject<void>>;
    updateMinimumPodSize(_nextMinimumPodSize: number|string|BN, options?: Tx): Promise<TransactionObject<void>>;
    updateMinimumEpochInterval(_nextMinimumEpochInterval: number|string|BN, options?: Tx): Promise<TransactionObject<void>>;
    updateSlasher(_slasher: string, options?: Tx): Promise<TransactionObject<void>>;
    slash(_prover: string, _challenger1: string, _challenger2: string, options?: Tx): Promise<TransactionObject<void>>;
    refund(_darknodeID: string, options?: Tx): Promise<TransactionObject<void>>;
